...
def sweep_unique_combinations_with_progress(E=20, D=100, alpha=0.01, manip_index=0):
    n = 4
...
if __name__ == "__main__":
    ...
    excel_filename = "cg_cea_sweep_results_full_E20.xlsx"
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("cg_cea_sweep_a0_unique_weighted_E20.png", dpi=200)
    print(f"\n Plot saved to cg_cea_sweep_a0_unique_weighted_E20.png")
    plt.show()
